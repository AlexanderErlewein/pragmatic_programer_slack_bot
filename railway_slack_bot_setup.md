# Pragmatic Programmer Slack Bot - Railway Deployment

## 📁 Projektstruktur

Erstelle diese Dateien in einem neuen Ordner:

### `package.json`
```json
{
  "name": "pragmatic-programmer-slack-bot",
  "version": "1.0.0",
  "description": "Daily Pragmatic Programmer tips for Slack",
  "main": "index.js",
  "scripts": {
    "start": "node index.js",
    "dev": "node index.js"
  ...
  "keywords": ["slack", "bot", "pragmatic-programmer", "daily-tips"],
  "author": "Your Name",
  "license": "MIT"
}
```
...
### `README.md`
```markdown
# Pragmatic Programmer Slack Bot
...
### 1. **Bereite deinen Code vor**
```bash
mkdir pragmatic-slack-bot
cd pragmatic-slack-bot

# Kopiere die Dateien (package.json, index.js, etc.) in diesen Ordner

# Git Repository initialisieren
git init
git add .
git commit -m "Initial commit: Pragmatic Programmer Slack Bot"
```
...
- Pushe deinen Code:
```bash
git remote add origin https://github.com/DEIN-USERNAME/pragmatic-slack-bot.git
git branch -M main
...
SLACK_CHANNEL_ID=#dev-team
DAILY_TIME=09:00
TIMEZONE=Europe/Berlin
```

### 5. **Slack App konfigurieren**
...
## 💰 Kosten
- **Railway**: $5 Guthaben/Monat kostenlos
- **Dein Bot**: ~$0.10/Monat (sehr wenig Resource-Verbrauch)

## ✅ Vorteile der Railway-Version
- **Auto-Deploy**: Bei jedem Git Push
- **Health Checks**: `/health` endpoint
- **Graceful Shutdown**: Proper cleanup
- **Environment Variables**: Sichere Konfiguration
- **Logs**: Einfaches Debugging im Railway Dashboard

Der Bot läuft dann 24/7 in der Cloud und postet täglich automatisch! 🎉